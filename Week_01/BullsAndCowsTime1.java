 ...
 *
 * @Author: Xiao Xuezhi
 * @Date: 2020/8/15 22:22
 * @Version： 1.0
 */
public abstract class BullsAndCowsTime1 {

    public abstract String getHint(String secret, String guess);

    public static void main(String[] args) {
        BullsAndCowsTime1 solution = new Solution1();
        System.out.println(solution.getHint("1123", "0111"));
    }

    public static class Solution1 extends BullsAndCowsTime1 {

        @Override
        public String getHint(String secret, String guess) {
            int bull = 0, cow = 0, l = secret.length();
            ...
            for (int i = 0; i < l; i++) {
                ...
                if (c == guessChar[i]) {
                    ...
                    secretCount[secretChar[i] - '0']++;
                    guessCount[guessChar[i] - '0']++;
                }
            }
            for (int i = 0; i < 10; i++) {
